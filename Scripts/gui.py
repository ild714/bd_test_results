...
def GlobEl3(root,ent1,root2,color6,color7,font1):
    ...
    Выполнил  Сапожников А.А."""
    global data,max_rows,max_cols, max_rows1
    data,max_rows,max_cols,max_rows1 = Add(max_rows,max_cols,root2,data,ent1,root,max_rows1,color6,color7,font1)
...
def WinBaza(root,color2,color1,color3,color5,color4,color6,color7,font1,font):
    ...
    btn4 = Button(root1,width=6, text="OK", command = lambda:GlobEl2(root,ent1,ent2,root1,color6,color7,color8,color9,font1), font = font)
    btn4['bg'] = color1
...
def WinAdd(root,color2,color1,color3,color5,color4,color6,color7,font1,font):
    ...
    if data:
        ...
        btn4 = Button(root2, width=6, text="OK", command = lambda:GlobEl3(root,ent1,root2,color6,color7,font1), font = font)
        btn4['bg'] = color1
        btn4['activebackground'] = color3
        btn4['fg'] = color5
        btn4['activeforeground'] = color4
...
btn5 = Button (width = 17, text = "Доп. функции",command = lambda:WinFun(data,max_rows1,rows,color6,color7,color8,color9,
